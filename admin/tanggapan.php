...
<div class="card shadow">
    ...
    <a href="?url=verifikasi_pengaduan&id" class="btn btn-primary btn-icon-split">
     ...
     <form action="simpan_tanggapan.php" method="post" class="form-horizontal" enctype="multipart/form-data"> 
            ...
            <div class="form-group cols-sm-6 m-3">
            ...
            <div class="form-group cols-sm-6 m-3">
                ...
                <textarea type="text" value="<?php echo $data=['isi_laporan']; ?>" class="form-control" rows="6" name="tanggapan">
                </textarea>
            </div>
