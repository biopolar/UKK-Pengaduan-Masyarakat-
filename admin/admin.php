...
if($_SESSION['level'] !== "admin") // Perhatikan penggunaan operator !== untuk memeriksa bahwa level bukan "admin".
{
  die("Anda Bukan Admin!");
}
// Lanjutkan dengan halaman admin Anda di sini.
?>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item" href="?url=preview_petugas" target="_blank">Laporan Petugas</a>
